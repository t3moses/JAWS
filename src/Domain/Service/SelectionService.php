...
class SelectionService
{
    ...
    private function case1(array $boats, array $crews): void
    {
        ...
        // Cut boats from the front (lowest rank) until we have enough berths
        while ($allBerths > $crewCount) {
            $cutBoat = array_shift($boats);
        ...
        if ($allBerths === $crewCount) {
            ...
            // max_berths has to be greater than min_berths
            // Use case 3 to distribute optimally
            $this->case3($boats, $crews);
        }
    }
    ...
    private function case2(array $boats, array $crews): void
    {
        ...
        // Cut crews from the front (lowest rank)
        $waitlistCrews = array_slice($crews, 0, $excessCrews);
        $crews = array_slice($crews, $excessCrews);
