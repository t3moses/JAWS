...
**API Style:** REST/JSON with name-based authentication
...
**Apply Migration:**
```bash
sqlite3 database/jaws.db < database/migrations/002_new_migration.sql
```
...
- **Use Cases** (`UseCase/`)
  - `Boat/RegisterBoatUseCase.php` - Register new boat
  - `Boat/UpdateBoatAvailabilityUseCase.php` - Update boat berths for events
  - `Crew/RegisterCrewUseCase.php` - Register new crew
...
- **DTOs** (`DTO/`)
  - `Request/RegisterBoatRequest.php` - Boat registration data
  - `Request/RegisterCrewRequest.php` - Crew registration data
...
- **Middleware** (`Middleware/`)
  - `NameAuthMiddleware.php` - Headers: X-User-FirstName, X-User-LastName
...
**Headers Required:**
```
X-User-FirstName: {firstName}
X-User-LastName: {lastName}
```

**POST /api/boats/register**
- Register new boat
- Controller: `AvailabilityController::registerBoat()`
- Triggers: `ProcessSeasonUpdateUseCase`

**PATCH /api/boats/availability**
- Update boat berths for events
- Controller: `AvailabilityController::updateBoatAvailability()`
- Triggers: `ProcessSeasonUpdateUseCase`

**POST /api/crews/register**
- Register new crew
- Controller: `AvailabilityController::registerCrew()`
- Triggers: `ProcessSeasonUpdateUseCase`

**PATCH /api/users/me/availability**
- Update crew availability for events
- Controller: `AvailabilityController::updateCrewAvailability()`
- Triggers: `ProcessSeasonUpdateUseCase`
...
- `Tests/api_test.php` - Simple HTTP test suite (curl-based)
...
6. Write tests: `tests/Integration/Api/` or `Tests/api_test.php`
...
// Use Cases
$container->set(RegisterBoatUseCase::class, fn() => new RegisterBoatUseCase(
    $container->get(BoatRepositoryInterface::class),
    $container->get(RankingService::class)
));
```
...
- `src/Application/UseCase/Boat/RegisterBoatUseCase.php`
- `src/Application/UseCase/Crew/RegisterCrewUseCase.php`
