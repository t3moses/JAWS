...
<body>
    ...
    <form class = "form_class" action="account_boat_login_process.php" method="POST">
        <label class = "label_class" >Boat name:</label>
        <input class = "text_class" type="text" name="bname" required><br><br>
    ...
    <p><a class = "p_class" href="/account_boat_data_form.html">Don't have an account yet? Register here</a></p>
</body>
</html>